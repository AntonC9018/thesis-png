...
menționată în secțiunea despre proiectare a parserului.
...
însă acestea de obicei nu conțin operații de citire.
...
\section{Calculul CRC}\label{appendix:crc_sequence_defer_example}
% \inputminted[firstline=705, lastline=763]{zig}{../src/parser/pipelines.zig}
