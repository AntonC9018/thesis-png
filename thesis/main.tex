...
\newcommand{\conducatorName}{Pereteatcu Sergiu}
...
Test random text: \TotalValue{chapter}

\IsTotalCounterTF{chapter}{yes, total counter}{no, not total counter}

\input{foaie_de_titlu_ro}
