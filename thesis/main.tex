...
(1) studierea și înțelegerea formatului \ac{PNG} și a formaturile de comprimare asociate 
...
Pentru a crea aplicația ajung documentele de specificație a formaturile necesare,
...
Este explicat procesul de gândire în ceea ce ține divizarea aplicații la module,
...
\chapter{Introducerea fundalului de informații}\label{intro_chapter_title}
...
În acest capitol au fost introduse formatul \ac{PNG} și
formatul de comprimare Zlib care este folosit în formatului \ac{PNG}.
A fost descrisă structura formatului \ac{PNG}: ce sunt chunk-urile,
de ce sunt folosite, ce tipuri există, câmpurile principale, etc.
...
Fiind echipat cu aceste cunoștințe,
devine posibilă abordarea proiectării
și programării aplicației orientate spre lucrul cu aceste formaturi.


\chapter{Planificarea Aplicației}\label{architecture_chapter_title}
...
Pe \refFigure{interface_sketch.png} puteți vedea o schiță a interfeței grafice,
...
Ideea este ilustrată pe \refFigure{sequence_example.png}.
...
Pe \refFigure{ui_example_2.png} se poate observa ca unul din octeți este albastru.
...
După implementarea unei aplicații de așa scop scăzut și tehnic,
