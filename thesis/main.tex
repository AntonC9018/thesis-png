...
din cauza că cunoașterea întregul sistem ca unul singur încă nu era atinsă de programator.
...
la care acesta a ajuns pe baza intuiției derivate din experiență și pe baza cerințelor.
...
\begin{itemize}
  ...
  Acest modul este o abstracție importantă pentru a simplica interacționa cu
  ...
  Acesta nu trebuie să existe ca un obiect, ajunge și niște funcții care să poată
  fi apelate pentru a realiza transformarea.
  ...
  Acest modul ar trebui să aibă control asupra pozițiilor de start și de sfârșit ale segmentelor de fișier
  care sunt vizualizate în momentul dat, 
