...
Inițial, parser-ul se află într-o stare destinată validării a semnaturii fișierului PNG.
Semnatura este o secvență specială de caractere care 
trebuie necesar să apare la începutul oricărui fișier PNG.
...
Aceasta poate fi implementată în mod cel mai simplu can un \textt{enum}
