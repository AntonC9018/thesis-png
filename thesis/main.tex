...
The obtained results were reported on \textbf{\conferencesList}.
...
\imageWithCaption{sequence_example.png}{
    Ilustrarea principiului de funcționare a unei secvențe.}
...
Există așa se de binding-uri și pentru Raylib\cite{raylib_zig}.
Acesta se integrează cu proiectul folosind sistemul \texttt{zig build}
