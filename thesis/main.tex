...
Partea esențială a formatului Zlib este subformatul integrat Deflate.
Deflate definește 3 mecanisme de comprimare: datele fără comprimare,
și comprimarea folosind arbori Huffman, metoda fixă și metoda dinamică.
...
folosit pentru decomprimare a fluxului de biți în continuare.
...
ori referințe de o anumită lungime înapoi la bufer decomprimat,
după anumită distanță de la poziția corectă.
Aceste simboluri nu există 
